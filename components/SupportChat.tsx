...
const SupportChat: React.FC = () => {
  ...
  return (
    <div className="relative flex h-full min-h-0 w-full flex-col bg-[#F6F1E7] text-[#3D3D3D]">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-[0.2] [background-image:radial-gradient(rgba(148,163,184,0.18)_1px,transparent_1px)] [background-size:26px_26px]" />
      </div>

      <div className="relative z-10 flex h-full min-h-0 w-full flex-col px-4 pb-[calc(env(safe-area-inset-bottom)+16px)] sm:px-6 md:px-8">
        <div className={`flex flex-wrap items-center justify-between gap-4 border-b border-[#E6E1D8] py-4 ${hasThread ? 'pt-2' : ''}`}>
        ...
        <div className="relative flex-1 min-h-[360px] pt-4 sm:min-h-[420px]">
          <div className="h-full w-full min-h-[360px] sm:min-h-[420px]">
            <ChatKit control={control} className="h-full w-full min-h-[360px] sm:min-h-[420px]" />
          </div>
          {!isReady && (
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-t border-[#E6E1D8] py-3 text-xs text-[#6B6158]">
